...
class Groupsoal_model extends CI_Model
{
    private $_table = "groupsoal";
    ...
    {
        return $this->db->where('groupid', $id)->update($this->_table, $data);
    }
 ...
 // public function getById($id)
    ...
    // public function updateJenis_kehamilan($jenis_kehamilan_inputan, $id_useribu)
    // {
    //     return $this->db->get_where('user', ['jenis_kehamilan' => $jenis_kehamilan_inputan, 'id_user !=' => $id_useribu]);
    // }

    public function delete($id)
    {
        $this->db->delete($this->_table, array('groupid' => $id));
    }
}
