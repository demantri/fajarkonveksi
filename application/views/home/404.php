				...
				<div class="row text-left">
					<div class="col-sm-6">
						<div class="page_404_content">
							<h1>404</h1>
							<h3>The page you requeted cannot be found.</h3>
						</div>
						<div class="404_btn">
							<a href="index.html" class="btn border-btn"><i class="fa fa-arrow-circle-o-left"></i> Back To Home</a>
						</div>
					</div>
